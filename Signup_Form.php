...
<html>
    ...
    <div class="rightcolumn">
        ...
        <form>
        <h1>Sign Up</h1>
        <input type="text" placeholder="Full Name" required><div class="text"><img src="Images/login/name.png" width="100%" height="100%"></div></input>
        <br>

        <input type="email" placeholder="Email" required><div class="email"><img src="Images/login/mail.png" width="100%" height="100%"></div></input>
        <br>

        <input type="text" placeholder="Contact Number" required><div class="contact"><img src="Images/login/contact.png" width="100%" height="100%"></div></input>
        <br>
    ...
    <a href="Signup_Register.html"><button class="button" >Next ></button></a>
    </div>
</body> 
